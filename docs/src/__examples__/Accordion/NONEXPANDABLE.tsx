...
export default {
    ...
    return (
      <Accordion expandedSection={expandedSection} onExpand={id => setExpandedSection(String(id))}>
        ...
        <AccordionSection
          expandable={false}
          actions={
            <ButtonLink type="secondary" onClick={() => setExpandedSection("inbound")}>
  ...
  info: {
    title: "Non-expandable sections",
    description:
      "To prevent sections from being expanded, set <code>expandable</code> to <code>false</code>. This means any actions are not displayed.",
  },
};
