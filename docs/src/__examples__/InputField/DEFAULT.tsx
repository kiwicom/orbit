  ...
  exampleKnobs: [
    {
      ...
      knobs: [
        ...
        { name: "minValue", type: "number", defaultValue: undefined },
        { name: "maxValue", type: "number", defaultValue: undefined },
        { name: "minLength", type: "number", defaultValue: undefined },
        { name: "maxLength", type: "number", defaultValue: undefined },
