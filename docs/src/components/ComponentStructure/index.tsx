...
const StyledPanel = styled.div<{ theme: typeof docsTheme } & React.PropsWithChildren>`
  ${({ theme }) => css`
...
const StyledImageContainer = styled.div<{ theme: typeof docsTheme } & React.PropsWithChildren>`
  ${({ theme }) => css`
    display: grid;
...
const StyledComponentParts = styled.div<
  { vertical?: boolean; theme: typeof docsTheme } & React.PropsWithChildren
>`
  ${({ theme, vertical }) => css`
    display: grid;
