...
Switching between variations or removing default values takes a few seconds for every use of a component.
...
- Mobile-first always:
  ...
  and 344px for components intended to be inside of wrappers.
...
- Use the same names for components and their parts in the design tool as in code.
  This will help make handover between design and code smoother.
