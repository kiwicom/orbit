...
- All of our colors are also defined as **design tokens**,
...
- <InlineToken value="paletteWhite" alternateName />
- <InlineToken value="paletteCloudLight" alternateName />

And four colors to create status backgrounds:

- <InlineToken value="paletteBlueLight" alternateName />
- <InlineToken value="paletteGreenLight" alternateName />
- <InlineToken value="paletteOrangeLight" alternateName />
- <InlineToken value="paletteRedLight" alternateName />
...
All of these elements should be colored in <InlineToken value="paletteBlueNormal" alternateName />.
...
For the actionable color, we use our main **<InlineToken value="paletteProductNormal" alternateName/>**.
...
We're aware of a **slight contrast issue with Kiwi.com's Product Normal color**
...
Use <InlineToken value="colorInputBorder" alternateName/> instead.
...
Even better, rely on the value of <InlineToken value ="colorTextPrimary" />
...
We have several components in Orbit that do this---Alert, Badge, and Text all have a warning type.
...
<Guideline type="do" title="Use Red for destructive buttons">
...
<Guideline type="do" title="Use Facebook color only for Facebook-related content">

That basically means that we use the Facebook color only in [Facebook login buttons](/components/action/socialbutton/).
...
We just use the colored version of their logo and <InlineToken value="colorTextPrimary" /> for text.
