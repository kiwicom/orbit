...
- <InlineToken name="paletteWhite" alternateName />
- <InlineToken name="paletteCloudLight" alternateName />

And four colors to create status backgrounds:

- <InlineToken name="paletteBlueLight" alternateName />
- <InlineToken name="paletteGreenLight" alternateName />
- <InlineToken name="paletteOrangeLight" alternateName />
- <InlineToken name="paletteRedLight" alternateName />
...
Use <InlineToken name="colorInputBorder" alternateName/> instead.
