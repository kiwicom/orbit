...
import Palette from "../../../components/Placeholder";
...
- <InlineToken value="paletteWhite" />
- <InlineToken value="paletteCloudLight" />

And four colors to create status backgrounds:

- <InlineToken value="paletteBlueLight" />
- <InlineToken value="paletteGreenLight" />
- <InlineToken value="paletteOrangeLight" />
- <InlineToken value="paletteRedLight" />
...
All of these elements should be colored in <InlineToken value="paletteBlueNormal" />.
...
For the actionable color, we use our main **<InlineToken value="paletteProductNormal" />**.
...
Use <InlineToken value="colorInputBorder" /> instead.
