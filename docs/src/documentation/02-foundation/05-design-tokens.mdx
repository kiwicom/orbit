---
title: Design tokens
description: Design tokens store visual design attributes. They help us make our UI more consistent and we support custom themes.
---

import { Tips } from "@kiwicom/orbit-components/icons";

import DesignTokensList from "../../components/Placeholder";

<Callout type="warning" title="Design tokens and theming is still a work in progress." >

We're preparing a new specification of how we want theming work in Orbit. More soon.
