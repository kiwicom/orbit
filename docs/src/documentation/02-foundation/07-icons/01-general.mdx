...
We have an [icon font](https://images.kiwi.com/orbit-icons/orbit-icons-font.zip)
ready for use in mobile apps.
Copy the code of the icon you need and apply where necessary.

<FancyLink
  title="Download the icon font"
  href="https://images.kiwi.com/orbit-icons/orbit-icons-font.zip"
  icon="download"
/>
...
- [Download the entire icon](https://images.kiwi.com/orbit-icons/orbit-svgs.zip) set as a ZIP file.
