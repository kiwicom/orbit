...
- If the actions are important, fill the group with [buttons](/components/button/).
- If the actions are less important, fill the group with [button links](/components/buttonlink/).
...
<FigmaFile
  ...
  node="289%3A14"
  alt="Related actions: all actions within the group are visually connected; buttons: includes more important actions; ButtonLinks: includes less important actions."
/>
...
[buttons](/components/button/) or [button links](/components/buttonlink/).
