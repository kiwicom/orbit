...
To ease with keyboard navigation, when opening a modal, the focus is moved to the first focusable element inside the modal. It is also impossible to focus anything outside of the modal while it is open.
...
If you prefer, you can also provide those attributes manually, as described on the table below:
