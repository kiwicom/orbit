...
to stand out against the <InlineToken name="paletteWhiteNormal" alternateName /> background natural to the app.
...
the fields have a <InlineToken name="paletteWhiteNormal" alternateName /> background to stand out.
