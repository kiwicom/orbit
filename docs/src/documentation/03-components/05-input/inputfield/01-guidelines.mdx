...
- You want users to upload a gile---use an [input file](/components/input/inputfile/).
...
helps make it clear what is expected.
...
which will usually be placed against a <InlineToken value="paletteCloudLight" /> background,
