...
<FigmaFile
  ...
  node="83%3A130"
  alt="Title: clarifies what the choice offers; checkbox: optionally indicates when the choice is selectable; icon: visually supports the choice; description: optionally adds more explanation to the choice."
/>
...
This will slow down and confuse users.
...
Just remember that [not everyone will see your visual cues](/foundation/accessibility/),
...
so they are easy to skim through and find the information they need
(such as the distance).

<ReactExample name="ListChoice description" />

The descriptions are presented as secondary text,
o they should be used only for extra context and not vital information.
