...
<div>
  ...
  />
  <p id="country-info">Select the country where you currently reside.</p>
</div>
```
...
```jsx
<div>
  <p id="terms-info">Please review our terms and conditions.</p>
  <Select
...
In this example, both the "terms-info" text and the error message will be announced by screen readers.
