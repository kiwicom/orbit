...
Make sure everything necessary is presented to [people who won't see the picture](/foundation/accessibility/).
...
Providing text just gives users extra information that does not help them.
