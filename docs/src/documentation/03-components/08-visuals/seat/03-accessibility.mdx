...
- Use the `type` prop to properly indicate seat availability and special features.
...
Screen reader announces: "Seat 24B already occupied, button, unavailable".

#### Using External Labels

```jsx
<div>
  <span id="seat-label">Exit row seat 15F</span>
  <span id="seat-desc">Extra legroom, additional responsibilities</span>
  <Seat
    type="legroom"
...
Screen reader announces: "Exit row seat 15F Extra legroom, additional responsibilities, button, not pressed".

#### Seat Legend with Accessibility Label

```jsx
<SeatLegend type="legroom" label="Extra legroom" aria-label="Extra legroom seat indicator" />
```

Screen reader announces: "Extra legroom seat indicator".
