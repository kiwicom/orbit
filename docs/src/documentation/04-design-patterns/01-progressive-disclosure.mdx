...
it will be difficult for them to choose what is important and what isn't.
...
and increases the chance that **they won't do anything**.
...
![An input field with the text 'Add place' and some suggested destinations.](images/NomadAddDestination.png)
...
![The text 'London' and 'Stay 3--5 nights', with the length of stay underlined and an edit button next to it.](images/NomadHoverLength.png)

If you select this, you'll find additional options for the length of stay.

![The same text as before, now with a slider underneath to select the length of stay from 1 to 60 nights.](images/NomadChangeLength.png)
...
[Truncate components](/components/utilities/truncate/) make long text fit within a given space.
...
They are a basic way of keeping information present but hidden.
