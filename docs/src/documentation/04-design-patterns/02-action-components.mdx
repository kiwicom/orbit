...
<FigmaFile
  ...
  node="96%3A1076"
  alt="A form with a primary button to 'Sign up'."
/>
...
<FigmaFile
  file="fannvRpkOJK6uxxT33EKaa"
  node="100%3A0"
  alt="Images, text, and buttons for three options: Add a meal, Rent a car, Add insurance. Each option has a primary subtle button."
/>
...
<FigmaFile
  file="fannvRpkOJK6uxxT33EKaa"
  node="101%3A0"
  alt="A modal to find accommodation, with a primary button to 'Find a room' and a secondary button to 'Close'."
/>
...
<FigmaFile
  file="fannvRpkOJK6uxxT33EKaa"
  node="101%3A52"
  alt="A dialog asking to confirm account deletion with a critical button to 'Delect account' and a secondary button to 'Cancel'."
/>
...
<FigmaFile
  file="fannvRpkOJK6uxxT33EKaa"
  node="105%3A2047"
  alt="A screen with details on a traveler, with a critical subtle button at the button to 'Delete traveler'."
  caption="This is followed by a dialog confirming the deletion with a critical button (not a subtle one)."
/>
...
<FigmaFile
  file="fannvRpkOJK6uxxT33EKaa"
  node="111%3A1400"
  alt="A dark tooltip with some text and a white button to 'Learn more'."
/>
...
<ReactExample exampleId="Alert-actions_side-by-side" />
...
<FigmaFile
  file="fannvRpkOJK6uxxT33EKaa"
  node="104%3A180"
  alt="A modal with a form for places to visit, a primary button to 'Search journey', and a primary button link to 'Add destination'."
/>
...
<FigmaFile
  file="fannvRpkOJK6uxxT33EKaa"
  node="104%3A36"
  alt="A search filter with a list of carriers that is incomplete and a secondary button link to 'Show all carriers'."
/>
...
<FigmaFile
  file="fannvRpkOJK6uxxT33EKaa"
  node="105%3A2185"
  alt="A form to edit payment card details with a secondary button to 'Close' and a critical button link to 'Delete card'."
  caption="This can be followed by a confirmation dialog with a critical button."
/>
