...
excerpt: How to put together forms to make them easy to complete
redirect_from:
...
as there is not enough space for multiple columns,
...
instead of a basic [input field](/components/inputfield/).
...
In this way, users can see that there is an error
and will see the message after they focus on the corresponding field.
