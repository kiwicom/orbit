...
This means that a vast number of tailwind classes were also updated to reflect these changes. Below, some examples of the updated classes, although we are not listing all of them, as there are too many:
...
The `borderRadius` prop was updated to reflect the changes in the design tokens.
