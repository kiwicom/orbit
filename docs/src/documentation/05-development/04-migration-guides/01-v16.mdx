...
```jsx
<Box borderRadius="50" elevation="level1">"50" borderRadius</Box>
<Box borderRadius="100" elevation="level3">"100" borderRadius</Box>
<Box borderRadius="150" elevation="level3Reverse">"150" borderRadius</Box>
<Box borderRadius="full" elevation="level4">"full" borderRadius</Box>
```
