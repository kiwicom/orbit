...
excerpt: Basic grammar guidelines for writing with Orbit.
---
...
Always include diacritics if they are there:
Oliver Dlouhý, Petra Vaškových.

## Punctuation

Prefer em dashes (---) over semicolons---never use hyphens unless you are hyphenating.

Use en dashes to connect things, such as times and dates, in short forms:
Jan 24--Feb 28, 10:00--14:00.
...
For anything else, m or bn is ok, depending on how it reads: \$60bn.
...
<Guidelines type="do" title="List items should have parallel structures">
...
<Guidelines type="do" title="Don't vary the item structure">
...
it's an impossible read that most people just cannot get through
