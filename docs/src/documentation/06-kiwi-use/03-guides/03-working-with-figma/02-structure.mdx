...
<FigmaFile
  file="MXRGcpnsoTFNiGyZ0tSIjj"
  node="2%3A26"
  alt="The top level is organization, followed by teams, projects, and files."
/>
...
<FigmaFile
  ...
  node="11%3A0"
  alt=""
  caption="Each project should have a description of what it contains."
/>
...
<FigmaFile
  ...
  node="2%3A26"
  alt=""
  caption="An example component inside the native Booking library."
/>
...
Keeping explorations separate like this will ensure
that your core Figma files won't grow in size over time
...
<FigmaFile
  ...
  node="19%3A0"
  alt=""
  caption="Proper naming makes the archive easy to scan."
/>
...
<FigmaFile
  ...
  node="25%3A0"
  alt=""
  caption="Using tags makes it easier to scan files inside a project."
/>
...
Inside your files, you will have various kinds of pages.
...
<FigmaFile
  ...
  node="28%3A0"
  alt=""
  caption="Covers make it easier to understand the contents of each file."
/>
...
<FigmaFile
  file="T32gf6jCzHNhwOh0LZGANQ"
  node="5%3A762"
  alt="A header with statuses: Design approved, Copy in progress, Dev in progress. Title: 320 v1.8. Description: Added a new step with confirmation for unsubscribing. Added native NPS."
/>
...
While it is possible to have multiple iterations and multiple files,
...
nd also prevents them from getting lost when [older iterations are deleted](#remove-old-iterations).
...
Each screen will be related to others in its group.
...
This will clearly show what your plans are for the future.
