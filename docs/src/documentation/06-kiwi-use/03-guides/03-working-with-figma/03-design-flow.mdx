...
These will be placed in a separate team ([read about why](/kiwi-use/guides/working-with-figma/#why-are-mobile-and-desktop-split-into-two-teams))
and the [designs can be linked](h/kiwi-use/guides/working-with-figma/#linking-designs)
...
This isn't a value that will actually be used,
