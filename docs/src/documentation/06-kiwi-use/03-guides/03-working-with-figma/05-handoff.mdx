...
Designers will share works in progress with you because they value your feedback in shaping the design.
...
you'll find them in the **Code** tab on the right
...
If you select components, their names and descriptions will show as code comments.
Similarly, the names of selected styles will appear as comments,
...
(dragging your cursor won't work).
...
Contact them and ask them to [turn it back on](https://help.figma.com/hc/en-us/articles/360040045574-Prevent-Viewers-from-copying-sharing-and-exporting-from-Files).
