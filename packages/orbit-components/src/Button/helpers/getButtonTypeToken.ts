...
const getButtonTypeToken = ({
  ...
  const tokens = {
    [TOKENS.backgroundButton]: {
      ...
      [TYPE_OPTIONS.PRIMARY_SUBTLE]: theme.orbit.backgroundButtonPrimarySubtle,
      [TYPE_OPTIONS.CRITICAL_SUBTLE]: theme.orbit.backgroundButtonCriticalSubtle,
    ...
    [TOKENS.backgroundButtonHover]: {
      ...
      [TYPE_OPTIONS.PRIMARY_SUBTLE]: theme.orbit.backgroundButtonPrimarySubtleHover,
      [TYPE_OPTIONS.CRITICAL_SUBTLE]: theme.orbit.backgroundButtonCriticalSubtleHover,
    ...
    [TOKENS.backgroundButtonActive]: {
      ...
      [TYPE_OPTIONS.PRIMARY_SUBTLE]: theme.orbit.backgroundButtonPrimarySubtleActive,
      [TYPE_OPTIONS.CRITICAL_SUBTLE]: theme.orbit.backgroundButtonCriticalSubtleActive,
    ...
    [TOKENS.backgroundButtonFocus]: {
      ...
      [TYPE_OPTIONS.PRIMARY_SUBTLE]: theme.orbit.backgroundButtonPrimarySubtleFocus,
      [TYPE_OPTIONS.CRITICAL_SUBTLE]: theme.orbit.backgroundButtonCriticalSubtleFocus,
      [TYPE_OPTIONS.BUNDLE_BASIC]: theme.orbit.backgroundButtonBundleBasic,
      [TYPE_OPTIONS.BUNDLE_MEDIUM]: theme.orbit.backgroundButtonBundleMedium,
      [TYPE_OPTIONS.BUNDLE_TOP]: theme.orbit.backgroundButtonBundleTop,
    },
    [TOKENS.colorTextButton]: {
      ...
      [TYPE_OPTIONS.PRIMARY_SUBTLE]: theme.orbit.colorTextButtonPrimarySubtle,
      [TYPE_OPTIONS.CRITICAL_SUBTLE]: theme.orbit.colorTextButtonCriticalSubtle,
    ...
    [TOKENS.colorTextButtonHover]: {
      ...
      [TYPE_OPTIONS.PRIMARY_SUBTLE]: theme.orbit.colorTextButtonPrimarySubtleHover,
      [TYPE_OPTIONS.CRITICAL_SUBTLE]: theme.orbit.colorTextButtonCriticalSubtleHover,
      [TYPE_OPTIONS.BUNDLE_BASIC]: theme.orbit.paletteWhite,
      [TYPE_OPTIONS.BUNDLE_MEDIUM]: theme.orbit.paletteWhite,
      [TYPE_OPTIONS.BUNDLE_TOP]: theme.orbit.paletteWhite,
    },
    [TOKENS.colorTextButtonActive]: {
      ...
      [TYPE_OPTIONS.PRIMARY_SUBTLE]: theme.orbit.colorTextButtonPrimarySubtleActive,
      [TYPE_OPTIONS.CRITICAL_SUBTLE]: theme.orbit.colorTextButtonCriticalSubtleActive,
      [TYPE_OPTIONS.BUNDLE_BASIC]: theme.orbit.paletteWhite,
      [TYPE_OPTIONS.BUNDLE_MEDIUM]: theme.orbit.paletteWhite,
      [TYPE_OPTIONS.BUNDLE_TOP]: theme.orbit.paletteWhite,
    },
