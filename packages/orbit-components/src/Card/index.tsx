...
export default function Card({
  ...
  return (
    <div
      id={id}
      className={cx(
        "orbit-card font-base bg-white-normal [&>*]:border-elevation-flat-border-color lm:[&>*:first-child]:rounded-t-100 lm:[&>*:last-child]:rounded-b-100 w-full [&>*:first-child]:border-t",
