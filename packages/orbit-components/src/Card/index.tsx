...
export default function Card({
  ...
  return (
    <div
      id={id}
      className={cx(
        "orbit-card font-base bg-white-normal *:border-elevation-flat-border-color lm:first:*:rounded-t-300 lm:last:*:rounded-b-300 lm:rounded-300 w-full first:*:border-t",
