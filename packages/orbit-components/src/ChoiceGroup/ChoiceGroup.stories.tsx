...
export const VisualTest = () => {
  return (
    <div className="space-y-xl">
      <ChoiceGroup onChange={action("change")}>
      ...
      <div className="space-x-xs flex">
        {Object.values(LABEL_SIZES).map(size => (
          <ChoiceGroup label="Some choices lmao" labelSize={size} onChange={action("change")}>
            <Radio label="Lol" value="lol" />
            <Radio label="Kek" value="kek" />
            <Radio label="Bur" value="bur" disabled />
          </ChoiceGroup>
      ...
      <ChoiceGroup label="Some choices lmao" error="God damnit" onChange={action("change")}>
        <Radio label="Lol" value="lol" />
        <Radio label="Kek" value="kek" />
        <Radio label="Bur" value="bur" disabled />
      </ChoiceGroup>

      <ChoiceGroup label="Some choices lmao" filter onChange={action("change")}>
        <Radio label="Lol" value="lol" />
        <Radio label="Kek" value="kek" />
        <Radio label="Bur" value="bur" disabled />
      </ChoiceGroup>
