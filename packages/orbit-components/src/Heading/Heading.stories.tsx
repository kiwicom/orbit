...
type HeadingPropsAndCustomArgs = React.ComponentProps<typeof Heading> & {
  customTitle: string;
};

const meta: Meta<HeadingPropsAndCustomArgs> = {
  title: "Heading",
  component: Heading,
...
export default meta;
type Story = StoryObj<HeadingPropsAndCustomArgs>;
