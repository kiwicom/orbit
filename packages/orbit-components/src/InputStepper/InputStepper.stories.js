...
import { Default as ExampleDefault, Help as ExampleHelp, Error as ExampleError } from "./__docs__";
...
export default {
  ...
  includeStories: ["Default", "WithHelp", "WithDifferentSize", "Stateless", "Playground", "RTL"],
};
