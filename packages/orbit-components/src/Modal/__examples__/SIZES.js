...
export default {
  ...
  info: {
    title: "Sizes",
    description: `Modals can have four sizes: extra small (${defaultTheme.orbit.modalWidthExtraSmall}), small (${defaultTheme.orbit.modalWidthSmall}), normal (${defaultTheme.orbit.modalWidthNormal}, the default), and large (${defaultTheme.orbit.modalWidthLarge}). This sets their maximum width on larger screens`,
  },
};
