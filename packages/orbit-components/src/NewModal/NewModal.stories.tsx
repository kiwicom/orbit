...
import Box from "../Box";
import { ModalHeader, ModalSection, ModalFooter } from "../Modal";
...
export const Sizes = ({ size, title, description, mobileHeader, content }) => {
  ...
  return (
    <Container>
      <NewModal size={size} onClose={onClose} mobileHeader={mobileHeader}>
...
export const ShortModal = () => {
  ...
  return (
    <Container>
      <NewModal onClose={onClose} fixedFooter>
        <ModalSection>
          <Stack>
...
export const WithForm = ({ showMore }) => {
  ...
  return (
    <Container>
      <NewModal onClose={onClose} fixedFooter autoFocus={false}>
