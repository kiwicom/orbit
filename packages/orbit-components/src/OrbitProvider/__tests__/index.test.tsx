...
import tokensToCssVars from "@kiwicom/orbit-design-tokens/src/tokensToCssVars";
...
describe("OrbitProvider", () => {
  ...
  it("should add css variables to the head", () => {
    ...
    expect(document.getElementById(ID)?.innerText).toBe(
      tokensToCssVars({ tokens: getTokens(orbitTheme), cssClass: ":root" }),
    );
  });
});
