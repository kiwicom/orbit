      ...
      <FloatingFocusManager context={context}>
        <div
          ...
          className={cx(
            ...
            "bg-white-normal",
            "max-h-[calc(100%-(var(--spacing-800)))]",
            "focus:outline-none",
            "lm:top-(--popover-top)",
            "lm:left-(--popover-left)",
            "lm:right-(--popover-right)",
            "lm:bottom-(--popover-bottom)",
            ...
            "lm:shadow-level3",
            "lm:max-h-none",
            isInsideModal ? "lm:z-1000" : "lm:z-(--popover-zIndex)",
            width ? "lm:w-(--popover-width)" : "lm:w-auto",
