    ...
    <div className="orbit-slider relative" data-test={dataTest} id={id}>
      {hasHistogram ? (
        <>
          ...
          <div
            className={cx(
              "pb-200 tb:w-[calc(100%+48px)] tb:absolute tb:-bottom-400 tb:-inset-x-lg tb:pt-300 tb:px-600 tb:pb-1200 tb:rounded-100 tb:transition-opacity tb:ease-in-out tb:duration-fast tb:bg-white-normal tb:shadow-raised",
