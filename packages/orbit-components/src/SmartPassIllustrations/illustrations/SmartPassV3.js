...
const SmartPassV3 = ({ primary, secondary, ...props }: Props): React.Node => {
  ...
  const randomIDLinear4 = React.useMemo(() => randomID("linear4"), []);
  const randomIDLinear5 = React.useMemo(() => randomID("linear5"), []);
