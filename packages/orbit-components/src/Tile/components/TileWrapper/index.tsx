...
const TileWrapper = ({
  ...
  return (
    ...
    >
      {href ? (
        <a
          className="text-ink-dark focus:outline-blue-normal focus:[&_.orbit-tile-header-icon-right]:text-ink-light-hover link:text-ink-dark link:font-medium visited:text-ink-dark size-full block no-underline outline-none visited:font-medium focus:outline-2"
