...
const TileGroup = ({ children, dataTest, id, as }: Props) => {
  ...
  return (
    <Component
      className={cx(
        "shadow-level1 rounded-300 [&_.orbit-slide]:bg-white-normal m-0 w-full p-0",
        "first:[&_.orbit-tile-wrapper]:rounded-t-300 last:[&_.orbit-tile-wrapper]:rounded-b-300 not-last:[&_.orbit-tile-wrapper]:border-b not-last:[&_.orbit-tile-wrapper]:border-cloud-normal",
