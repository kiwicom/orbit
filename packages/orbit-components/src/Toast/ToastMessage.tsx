...
const ToastMessage = ({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="rounded-150 bg-white-normal absolute left-0 top-0 z-[1] size-full animate-[toast-light_var(--toast-message-duration)_linear] opacity-10 will-change-transform rtl:animate-[toast-light-rtl_var(--toast-message-duration)_linear]"
          style={
            {
