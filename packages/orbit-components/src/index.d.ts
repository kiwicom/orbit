...
export { DestinationHeader } from "./deprecated/DestinationHeader";
export { DestinationCard } from "./deprecated/DestinationCard";
export { DeprecatedSeat } from "./deprecated/Seat";
...
export { TripSegment } from "./deprecated/TripSegment";
export { TripSector } from "./deprecated/TripSector";
export { TripDate } from "./deprecated/TripSector/TripDate";
export { TripLayover } from "./deprecated/TripSector/TripLayover";
...
export { DeprecatedCard } from "./deprecated/Card";
export { DeprecatedCardHeader } from "./deprecated/Card/CardHeader";
export { DeprecatedCardSection } from "./deprecated/Card/CardSection";
