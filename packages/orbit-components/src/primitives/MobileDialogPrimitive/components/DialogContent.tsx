...
const DialogContent = ({
  ...
  return (
    <div className="w-full" role="dialog" id={dialogId} data-test={dataTest}>
      ...
      <div
        className={cx(
          "bg-ink-dark shadow-raised-reverse p-400 bottom-400 inset-x-md rounded-300 fixed z-[10012] box-border max-h-[calc(100%-theme(spacing.800))] w-[calc(100%-theme(spacing.800))] overflow-y-scroll",
