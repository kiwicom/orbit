      ...
      // Handle InputFile components
        ...
        attributes.push(
          j.jsxAttribute(
            ...
            createIntlMessageContainer(j, "common.screenreader.button.remove_file", "Remove file"),
          ),
        );
      }
      ...
      // Handle InputSelect components
        ...
        attributes.push(
          j.jsxAttribute(
            ...
            createIntlMessageContainer(j, "common.screenreader.button.clear_value", "Clear value"),
          ),
        );
      }
    });
