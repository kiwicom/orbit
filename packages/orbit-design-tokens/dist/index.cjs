...
var getTokens = (customFoundation) => {
  const theme = customFoundation ? ramda.mergeDeepRight(foundation_default, customFoundation) : foundation_default;
  return {
...
exports.convertHexToRgba = convertHexToRgba_default;
exports.defaultTokens = defaultTokens;
exports.foundation = foundation_default;
exports.fromPlainObject = fromPlainObject;
exports.getTokens = getTokens;
exports.palette = palette_default;
