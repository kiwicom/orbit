...
declare type WhiteColor = {
    normal: string;
    normalHover: string;
    normalActive: string;
};
declare type CloudColor = {
    light: string;
    lightHover: string;
    lightActive: string;
    normal: string;
...
declare type SocialColor = {
    facebook: string;
    facebookHover: string;
    facebookActive: string;
};
declare type BundleColor = {
    basic: string;
    medium: string;
};

declare type ConvertHexToRgba = (color: string, opacity: number) => string;
declare const convertHexToRgba: ConvertHexToRgba;
...
declare type ThemePaletteColors = {
...
declare type CustomBase = Partial<Base>;
declare type CustomFoundation = Partial<{
    palette: CustomPalette;
    base: CustomBase;
}>;

declare const getTokens: (customFoundation?: CustomFoundation) => Tokens;
declare const defaultTokens: Tokens;

declare const fromPlainObject: (themePaletteColors: ThemePaletteColors) => Tokens;

export { convertHexToRgba, defaultTokens, foundation, fromPlainObject, getTokens, palette };
