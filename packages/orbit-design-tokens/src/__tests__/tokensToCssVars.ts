import transformToCssVars from "../utils/tokensToCssVars";
...
describe("transformToCssVars", () => {
  it("should convert object into css variables string", () => {
    expect(transformToCssVars({ tokens, cssClass: false })).toMatchInlineSnapshot(`
      "--palette-product-normal: #ff0000;
      --palette-product-normal-hover: #e50000;
      --palette-product-normal-active: #cc0000;
      "
    `);
  });
  ...
  it("should convert nested object", () => {
    expect(
      ...
      "--tokens-palette-product-normal: #ff0000;
      --tokens-palette-product-normal-hover: #e50000;
      --tokens-palette-product-normal-active: #cc0000;
