...
export const getTokens = (customFoundation?: CustomFoundation): Tokens => {
  ...
  return {
    ...
    backgroundColorTabBundleBasic: `linear-gradient(80.91deg, ${theme.palette.bundle.basicGradientStart} 0%, ${theme.palette.bundle.basicGradientEnd} 100%)`,
    backgroundColorTabBundleMedium: `linear-gradient(80.91deg, ${theme.palette.bundle.mediumGradientStart} 0%, ${theme.palette.bundle.mediumGradientEnd} 100%)`,
    backgroundColorTabBundleTop: `linear-gradient(80.91deg, ${theme.palette.bundle.topGradientStart} 0%, ${theme.palette.bundle.topGradientEnd} 100%)`,
    backgroundButtonBundleBasic: `linear-gradient(to top right, ${theme.palette.bundle.basicGradientStart} 0%, ${theme.palette.bundle.basicGradientEnd} 100%)`,
    backgroundButtonBundleBasicHover: `linear-gradient(to top right, ${theme.palette.bundle.basicGradientStartHover} 0%, ${theme.palette.bundle.basicGradientStartHover} 100%)`,
    backgroundButtonBundleBasicActive: `linear-gradient(to top right, ${theme.palette.bundle.basicGradientStartActive} 0%, ${theme.palette.bundle.basicGradientStartActive} 100%)`,
    backgroundButtonBundleMedium: `linear-gradient(to top right, ${theme.palette.bundle.mediumGradientStart} 0%, ${theme.palette.bundle.mediumGradientEnd} 100%)`,
    backgroundButtonBundleMediumHover: `linear-gradient(to top right, ${theme.palette.bundle.mediumGradientStartHover} 0%, ${theme.palette.bundle.mediumGradientEndHover} 100%)`,
    backgroundButtonBundleMediumActive: `linear-gradient(to top right, ${theme.palette.bundle.mediumGradientStartActive} 0%, ${theme.palette.bundle.mediumGradientEndActive} 100%)`,
    backgroundButtonBundleTop: `linear-gradient(to top right, ${theme.palette.bundle.topGradientStart} 0%, ${theme.palette.bundle.topGradientEnd}  100%)`,
    backgroundButtonBundleTopHover: `linear-gradient(to top right, ${theme.palette.bundle.topGradientStartHover} 0%, ${theme.palette.bundle.topGradientEndHover}  100%)`,
    backgroundButtonBundleTopActive: `linear-gradient(to top right, ${theme.palette.bundle.topGradientStartActive} 0%, ${theme.palette.bundle.topGradientEndActive}  100%)`,
    ...
    backgroundBadgeBundleBasic: `linear-gradient(to top right, ${theme.palette.bundle.basicGradientStart} 0%, ${theme.palette.bundle.basicGradientEnd} 100%)`,
