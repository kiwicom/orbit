...
export const getTokens = (customFoundation?: CustomFoundation): Tokens => {
  ...
  return {
    ...
    colorTextInputDisabled: theme.palette.ink.light,
    ...
    colorIconRadioButtonDisabled: theme.palette.ink.light,
    ...
    borderColorInputHover: theme.palette.ink.lightHover,
    borderColorInputActive: theme.palette.ink.lightActive,
    ...
    paletteCloudDarker: theme.palette.cloud.dark,
    paletteCloudDarkerHover: theme.palette.cloud.darkHover,
    paletteCloudDarkerActive: theme.palette.cloud.darkActive,
    paletteInkLighter: theme.palette.ink.light,
    paletteInkLighterHover: theme.palette.ink.lightHover,
    paletteInkLighterActive: theme.palette.ink.lightActive,
