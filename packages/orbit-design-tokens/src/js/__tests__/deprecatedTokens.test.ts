...
const oldTokens = () => {
  ...
  return {
    ...
    backgroundButtonWhiteBorderedHover: transparentColor(theme.palette.white.normal, 20),
    backgroundButtonWhiteBorderedActive: transparentColor(theme.palette.white.normal, 20),
    ...
    backgroundTableShadowLeft: `linear-gradient(to left, transparent, ${transparentColor(
      theme.palette.ink.lighter,
      23,
    )})`,
    backgroundTableShadowRight: `linear-gradient(to right, transparent, ${transparentColor(
      theme.palette.ink.lighter,
      23,
    )})`,
    ...
    boxShadowButtonFocus: `0 0 4px 1px ${transparentColor(theme.palette.blue.normal, 30)}`,
    boxShadowAction: `0px 0px 2px 0px ${transparentColor(
      theme.palette.ink.normal,
      16,
    )}, 0px 1px 4px 0px ${transparentColor(theme.palette.ink.normal, 12)}`,
    boxShadowActionActive: `0px 1px 4px 0px ${transparentColor(
      theme.palette.ink.normal,
      16,
    )}, 0px 4px 8px 0px ${transparentColor(theme.palette.ink.normal, 12)}`,
    boxShadowFixed: `0px 0px 2px 0px ${transparentColor(
      theme.palette.ink.normal,
      16,
    )}, 0px 2px 4px 0px ${transparentColor(theme.palette.ink.normal, 12)}`,
    boxShadowFixedReverse: `0px 0px 2px 0px ${transparentColor(
      theme.palette.ink.normal,
      16,
    )}, 0px -2px 4px 0px ${transparentColor(theme.palette.ink.normal, 12)}`,
    boxShadowRaised: `0px 4px 8px 0px ${transparentColor(
      theme.palette.ink.normal,
      16,
    )}, 0px 8px 24px 0px ${transparentColor(theme.palette.ink.normal, 24)}`,
    boxShadowRaisedReverse: `0px -4px 8px 0px ${transparentColor(
      theme.palette.ink.normal,
      16,
    )}, 0px -8px 24px 0px ${transparentColor(theme.palette.ink.normal, 24)}`,
    boxShadowOverlay: `0px 12px 24px -4px ${transparentColor(
      theme.palette.ink.normal,
      24,
    )}, 0px 8px 60px 0px ${transparentColor(theme.palette.ink.normal, 32)}`,
