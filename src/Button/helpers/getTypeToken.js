...
const getTypeToken: GetTypeToken = name => ({ theme, type }) => {
  const tokens = {
    ...
    [TOKENS.borderColorButtonFocus]: {
      [TYPE_OPTIONS.PRIMARY]: convertHexToRgba(theme.orbit.backgroundButtonPrimary, 50),
      [TYPE_OPTIONS.SECONDARY]: convertHexToRgba(theme.orbit.paletteInkLight, 50),
      [TYPE_OPTIONS.INFO]: convertHexToRgba(theme.orbit.backgroundButtonInfo, 50),
      [TYPE_OPTIONS.SUCCESS]: convertHexToRgba(theme.orbit.backgroundButtonSuccess, 50),
      [TYPE_OPTIONS.WARNING]: convertHexToRgba(theme.orbit.backgroundButtonWarning, 50),
      [TYPE_OPTIONS.CRITICAL]: convertHexToRgba(theme.orbit.backgroundButtonCritical, 50),
      [TYPE_OPTIONS.FACEBOOK]: convertHexToRgba(theme.orbit.backgroundButtonFacebook, 50),
      [TYPE_OPTIONS.GOOGLE]: convertHexToRgba(theme.orbit.backgroundButtonGoogle, 50),
      [TYPE_OPTIONS.WHITE]: convertHexToRgba(theme.orbit.backgroundButtonWhite, 50),
    },
  };
