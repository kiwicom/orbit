...
const getToken = name => ({ theme, type }) => {
  const tokens = {
    [TOKENS.weightHeading]: {
      ...
      [TYPE_OPTIONS.SUBDISPLAY]: theme.orbit.fontWeightNormal, // TODO: create token fontWeightHeadingSubDisplay
    ...
    [TOKENS.sizeHeading]: {
      ...
      [TYPE_OPTIONS.SUBDISPLAY]: theme.orbit.fontSizeHeadingTitle2, // TODO: create token fontSizeHeadingSubDisplay
