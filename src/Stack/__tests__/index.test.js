...
describe("Default Stack", () => {
  ...
  it("should contain styles", () => {
    ...
    expect(stack).toHaveStyleRule("margin", "0 0 36px 0", {
      modifier: "& > *",
    });
    expect(stack).toHaveStyleRule("margin", "0 0 40px 0", {
...
describe("Stack with flex prop", () => {
  ...
  it("should contain styles", () => {
    ...
    expect(stack).toHaveStyleRule("margin", "0 0 16px 0", {
      modifier: "& > *",
    });
  });
  it("should match snapshot", () => {
...
describe("Stack with enabled flex", () => {
  ...
  it("should contain styles", () => {
    ...
    expect(stack).toHaveStyleRule("margin-bottom", defaultTokens.orbit.spaceLarge);
    expect(stack).toHaveStyleRule("margin", "0 16px 0 0", {
      modifier: "& > *",
    });
  });
  it("should contain desktop styles", () => {
    ...
    expect(stack).toHaveStyleRule("margin", "0 0 12px 0", {
      media: "(min-width:600px)",
      modifier: "& > *",
    });
  });
...
describe("Stack with same mobile and desktop properties", () => {
  ...
  it("should contain styles", () => {
    ...
    expect(stack).toHaveStyleRule("margin-bottom", defaultTokens.orbit.spaceLarge);
    expect(stack).toHaveStyleRule("margin", "0 36px 0 0", {
      modifier: "& > *",
    });
  });
  ...
  it("should contain desktop styles - only for spacing", () => {
    expect(stack).toHaveStyleRule("margin", "0 40px 0 0", {
      media: "(min-width:600px)",
      modifier: "& > *",
    });
  });
